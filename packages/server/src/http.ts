...
export function registerRoutes(
  ...
  // (Kräftebewegungen landen seit #227 NICHT mehr im ETB, sondern in einer
  // client-geführten Verschiebe-Historie im kräfteubersicht-Dokument — kein Endpoint nötig.)
